...
class WebSocketNodeConsumer(object):
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(queue=queue_name, callback=cb,exclusive=True,auto_delete=True)
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        if self.on_message_callback:
            self.on_message_callback(_unused_channel,basic_deliver, properties, body)
...
class ReconnectingWebSocketNodeConsumer(object):
    ...
    def __init__(self, amqp_url):
        ...
        self._consumer = WebSocketNodeConsumer(self._amqp_url)
...
def start_rabbitmq():
    # logging.basicConfig(level=logging.INFO, format=LOG_FORMAT)
    amqp_url = 'amqp://werido:359066432@43.128.110.230:30003/%2F'
    consumer = WebSocketNodeConsumer(amqp_url)
    consumer.run()
